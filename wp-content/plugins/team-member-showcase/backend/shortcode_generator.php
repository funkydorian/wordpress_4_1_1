...
'Team Member' => array(
	...
	'elements' => array(
			...
			'description' => __('To get all features working, please buy the pro version here <a target="_blank" href="http://wpexpert24.com/team-member-showcase-pro/">Team Member Showcase Pro</a> for only $11</a>', 'vp_textdomain'),
			'status' => 'error',
				),
...
// Open Soical Icon In New TAB
    array(
        'type' => 'checkbox',
        'name' => 'link_open_new_tab',
        'label' => __('Open Link In New TAB <P style="color:red; font-size;10px;">Pro Only</p>', 'vp_textdomain'),
        'description' => __('If you want to Open Social Icon Link In New Tab Just Check This Box', 'vp_textdomain'),
        'items' => array(
            array(
                'value' => '_blank',
